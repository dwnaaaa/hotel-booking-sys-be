...
CREATE TABLE BRN (
    ...
    CONSTRAINT BRN_PK PRIMARY KEY (BRN),
    CONSTRAINT BRN_FK1 FOREIGN KEY (ROOM_TYPE) REFERENCES ROOM_TYPE (ROOM_TYPE_ID),
    CONSTRAINT BRN_FK2 FOREIGN KEY (PRIMARY_GUEST_ID) REFERENCES GUEST_TABLE (GUEST_ID)
);
...
CREATE TABLE ROOM (
    ...
    CONSTRAINT BRN_FK FOREIGN KEY (BRN) REFERENCES BRN
);
